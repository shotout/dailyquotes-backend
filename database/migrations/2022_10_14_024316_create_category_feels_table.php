...
class CreateCategoryFeelsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('category_feels')->insert([
            ...
            ["category_id" => 18, "feel_id" => 2, "created_at" => now()],
            ["category_id" => 18, "feel_id" => 3, "created_at" => now()],
            ["category_id" => 18, "feel_id" => 4, "created_at" => now()],
            ["category_id" => 18, "feel_id" => 5, "created_at" => now()],
