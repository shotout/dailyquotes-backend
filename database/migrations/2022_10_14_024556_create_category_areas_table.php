...
class CreateCategoryAreasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('category_areas')->insert([
            ...
            ["category_id" => 24, "feel_id" => 8, "created_at" => now()],
            ...
            ["category_id" => 31, "feel_id" => 7, "created_at" => now()],
            ["category_id" => 31, "feel_id" => 8, "created_at" => now()],
            ...
            ["category_id" => 10, "feel_id" => 7, "created_at" => now()],
            ...
            ["category_id" => 9, "feel_id" => 7, "created_at" => now()],
            ["category_id" => 9, "feel_id" => 8, "created_at" => now()],
            ...
            ["category_id" => 7, "feel_id" => 7, "created_at" => now()],
            ["category_id" => 7, "feel_id" => 8, "created_at" => now()],

            // happiness
            ["category_id" => 8, "feel_id" => 2, "created_at" => now()],
            ["category_id" => 8, "feel_id" => 3, "created_at" => now()],
            ["category_id" => 8, "feel_id" => 5, "created_at" => now()],
            ["category_id" => 8, "feel_id" => 7, "created_at" => now()],

            // loving my body
            ["category_id" => 28, "feel_id" => 6, "created_at" => now()],
            ["category_id" => 28, "feel_id" => 7, "created_at" => now()],
            ...
            ["category_id" => 32, "feel_id" => 7, "created_at" => now()],
            ["category_id" => 32, "feel_id" => 8, "created_at" => now()],

            // success
            ["category_id" => 20, "feel_id" => 1, "created_at" => now()],
            ["category_id" => 20, "feel_id" => 2, "created_at" => now()],
            ["category_id" => 20, "feel_id" => 6, "created_at" => now()],
            ["category_id" => 20, "feel_id" => 8, "created_at" => now()],

            // reading
            ["category_id" => 25, "feel_id" => 1, "created_at" => now()],
            ["category_id" => 25, "feel_id" => 3, "created_at" => now()],
            ["category_id" => 25, "feel_id" => 8, "created_at" => now()],

            // leadership
            ["category_id" => 18, "feel_id" => 1, "created_at" => now()],
            ["category_id" => 18, "feel_id" => 6, "created_at" => now()],
            ["category_id" => 18, "feel_id" => 8, "created_at" => now()],
        ]);
    }
