...
class CreateCategoryAreasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('category_areas')->insert([
            // love
            ["category_id" => 15, "area_id" => 2, "created_at" => now()],
            ["category_id" => 15, "area_id" => 4, "created_at" => now()],
            ...
            // health
            ["category_id" => 27, "area_id" => 2, "created_at" => now()],
            ["category_id" => 27, "area_id" => 5, "created_at" => now()],
            ...
            // wellness
            ["category_id" => 25, "area_id" => 2, "created_at" => now()],
            ["category_id" => 25, "area_id" => 6, "created_at" => now()],

            // education
            ["category_id" => 22, "area_id" => 1, "created_at" => now()],

            // mindfulness
            ["category_id" => 29, "area_id" => 2, "created_at" => now()],
            ["category_id" => 29, "area_id" => 3, "created_at" => now()],
            ["category_id" => 29, "area_id" => 4, "created_at" => now()],
            ["category_id" => 29, "area_id" => 5, "created_at" => now()],
            ["category_id" => 29, "area_id" => 6, "created_at" => now()],
            ["category_id" => 29, "area_id" => 7, "created_at" => now()],
            ["category_id" => 29, "area_id" => 8, "created_at" => now()],

            // family
            ["category_id" => 17, "area_id" => 2, "created_at" => now()],
            ["category_id" => 17, "area_id" => 3, "created_at" => now()],
            ...
            ["category_id" => 26, "area_id" => 7, "created_at" => now()],

            // attitude
            ["category_id" => 10, "area_id" => 1, "created_at" => now()],
            ...
            ["category_id" => 10, "area_id" => 8, "created_at" => now()],
            ...
            // imagination
            ["category_id" => 31, "area_id" => 1, "created_at" => now()],
            ["category_id" => 31, "area_id" => 2, "created_at" => now()],
            ["category_id" => 31, "area_id" => 3, "created_at" => now()],
            ["category_id" => 31, "area_id" => 7, "created_at" => now()],

            // relationship
            ["category_id" => 14, "area_id" => 5, "created_at" => now()],
            ["category_id" => 14, "area_id" => 7, "created_at" => now()],

            // Dreams & Spirituality
            ["category_id" => 28, "area_id" => 2, "created_at" => now()],
            ["category_id" => 28, "area_id" => 3, "created_at" => now()],
            ...
            // dating
            ["category_id" => 18, "area_id" => 5, "created_at" => now()],
            ["category_id" => 18, "area_id" => 7, "created_at" => now()],

            // cool
            ["category_id" => 11, "area_id" => 1, "created_at" => now()],
            ["category_id" => 11, "area_id" => 2, "created_at" => now()],
            ["category_id" => 11, "area_id" => 6, "created_at" => now()],
            ["category_id" => 11, "area_id" => 7, "created_at" => now()],
            ["category_id" => 11, "area_id" => 8, "created_at" => now()],
            ...
            // wisdom
            ["category_id" => 30, "area_id" => 1, "created_at" => now()],
            ["category_id" => 30, "area_id" => 2, "created_at" => now()],
            ["category_id" => 30, "area_id" => 3, "created_at" => now()],
            ["category_id" => 30, "area_id" => 7, "created_at" => now()],
            ["category_id" => 30, "area_id" => 8, "created_at" => now()],

            // success
            ["category_id" => 21, "area_id" => 1, "created_at" => now()],
            ["category_id" => 21, "area_id" => 2, "created_at" => now()],
            ["category_id" => 21, "area_id" => 6, "created_at" => now()],
            ["category_id" => 21, "area_id" => 8, "created_at" => now()],

            // freedom
            ["category_id" => 32, "area_id" => 1, "created_at" => now()],
            ["category_id" => 32, "area_id" => 3, "created_at" => now()],
            ["category_id" => 32, "area_id" => 4, "created_at" => now()],
            ["category_id" => 32, "area_id" => 6, "created_at" => now()],
