...
class CreateCategoryWaysTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('category_ways')->insert([
            ...
            ["category_id" => 16, "way_id" => 4, "created_at" => now()],
            ...
            // mindfulness
            ["category_id" => 31, "way_id" => 1, "created_at" => now()],
            ["category_id" => 31, "way_id" => 2, "created_at" => now()],
            ["category_id" => 31, "way_id" => 4, "created_at" => now()],
            ["category_id" => 31, "way_id" => 5, "created_at" => now()],
            ...
            // being thankful
            ["category_id" => 11, "way_id" => 1, "created_at" => now()],
            ["category_id" => 11, "way_id" => 2, "created_at" => now()],
            ["category_id" => 11, "way_id" => 5, "created_at" => now()],
            ...
            // leadership
            ["category_id" => 18, "way_id" => 3, "created_at" => now()],
