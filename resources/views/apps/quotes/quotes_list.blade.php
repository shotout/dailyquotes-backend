...
@section('list-title')
  <h5><a href="{{ url('quotes/list') }}">{{ __('Quotes List') }}</a></h5>
@endsection
...
@section('list-form-content')
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 m-l-10 m-b-0">
    <div class="buttonRelation mt-3">      
      <a href="{{ url('quotes/create') }}" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-plus"> &nbsp;</span>Add New Quotes</a>
      <a href="{{ url('quotes/import-quotes') }}" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-plus"> &nbsp;</span>Import Quotes</a>
    </div>
  </div>
