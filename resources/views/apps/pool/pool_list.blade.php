...
@section('list-title')
  <h5><a href="{{ url('pool/list') }}">{{ __('What areas in life would you like to improve?') }}</a></h5>
@endsection
...
@section('list-form-content')
  @php  
    $from = $to = ''; 
  @endphp
  <div class="col-md-12 col-sm-12 col-xs-12 m-l-10 m-b-0" id="area-list-quote">
...
<script src="{{ asset('dist/js/custom/item.js') }}"></script>
